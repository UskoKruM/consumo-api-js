# Consumo de API usando JavaScript | HTML + Bootstrap + JSONPlaceholder

Consumo de una API usando JavaScript directamente ejecutado en el navegador web, usando un archivo HTML como base y estilizando el contenido con Bootstrap y CSS.
